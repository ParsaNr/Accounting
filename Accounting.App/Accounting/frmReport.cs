    ...
    public partial class frmReport : Form
    {
        ...
        void Filter()
        {
            using (UnitOfWork db = new UnitOfWork())
            {
                ...
                {
                    int id = int.Parse(cbCustomer.SelectedValue.ToString());
                    result.AddRange(db.AccountingRepository.Get(a => a.TypeID == TypeID && a.CostomerID == id));
                }
                else
                {
